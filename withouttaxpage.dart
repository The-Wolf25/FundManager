...
class forfriendtaxless extends StatefulWidget {
  const forfriendtaxless({Key? key}) : super(key: key);

  @override
  State<forfriendtaxless> createState() => _forfriendtaxlessState();
}

class _forfriendtaxlessState extends State<forfriendtaxless> {
  bool pressed = false;
  String name1 = "";
  String name2 = "";
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Individual Payment ( including taxes) : $res',
                          textAlign: TextAlign.center,
                          style: TextStyle(fontSize: 20),
                        ),
                      ),
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'Individual Payment ( including taxes) : $ress',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(fontSize: 20),
                                ),
                              ),
